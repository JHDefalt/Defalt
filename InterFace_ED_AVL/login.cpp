...
void login::setCall(int num)//获取呼叫者
{
    whoCalling = num;
}
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else if(whoCalling == 4) QDesktopServices::openUrl(QUrl::fromLocalFile("file:///C:\\CurriculumDesign\\ElectronicDictionary-AVL\\Dictionary"));
                else if(whoCalling == 5) QDesktopServices::openUrl(QUrl::fromLocalFile("file:///C:\\CurriculumDesign\\ElectronicDictionary-AVL\\ElectronicDictionary-AVL"));
            }
        }
    }
}
