...
void AVL::on_pushButton_clicked()//查询操作
{
...
void AVL::on_pushButton_2_clicked()//清空按钮
{
    if(ui->lineEdit->text() == "") QMessageBox::critical(this,"错误","请先输入内容！");
    else ui->lineEdit->setText(""),ui->textBrowser->setText("");
}

void AVL::on_actionInsert_triggered()//插入按钮
{
    login *ret = new login();
    ret->setCall(1);
    ret->Show();
...
void AVL::on_actionDelete_triggered()//删除按钮
{
    login *ret = new login();
    ret->setCall(2);
    ret->Show();
...
void AVL::on_actionModify_triggered()//修改按钮
{
    login *ret = new login();
    ret->setCall(3);
    ret->Show();
...
void AVL::on_actionc_triggered()//帮助按钮
{
    new help();
}

void AVL::on_actionasd_triggered()//打开词典按钮
{
    login *ret = new login();
    ret->setCall(4);
    ret->Show();
...
void AVL::on_actionasd_2_triggered()//关于按钮
{
    new about();
}

void AVL::on_actionyu_triggered()//作者邮箱按钮
{
...
void AVL::on_actiona_triggered()//打开源码按钮
{
    login *ret = new login();
    ret->setCall(5);
    ret->Show();
...
void AVL::on_actiona_3_triggered()//作者qq按钮
{
...
void AVL::on_actiona_4_triggered()//作者电话按钮
{
...
void AVL::keyPressEvent(QKeyEvent *event)//键盘绑定按钮
{
