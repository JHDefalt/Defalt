...
void modify::dowork()//修改主功能
{
    ...
    else
    {
        ...
        avl->target_word = ui->lineEdit_4->text().toStdString();
        if(avl->checkWord())
        {
            ...
            else
            {
                if(whoChecked == 1)
                {
                    ...
                    else
                    {
                        ...
                        avl->changeWord(nword, avl->ans->translate);
                ...
                else if(whoChecked == 2)
                {
                    ...
                    else
                    {
                        ...
                        avl->changeWord(avl->ans->word, nature + " " + mean);
                        QMessageBox::information(NULL, "提示", "更新成功");
                    }
                }
                else if(whoChecked == 3)
                {
                    ...
                    else
                    {
                        ...
                        avl->changeWord(avl->ans->word, avl->ans->translate + "@" + nature + " " + mean);
                        QMessageBox::information(NULL, "提示", "更新成功");
                    }
                }
            }
