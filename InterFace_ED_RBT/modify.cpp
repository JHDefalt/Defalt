...
void modify::dowork()//修改主功能
{
    ...
    else
    {
        ...
        rbt->target_word = ui->lineEdit_4->text().toStdString();
        if(rbt->checkWord())
        {
            ...
            else
            {
                if(whoChecked == 1)
                {
                    ...
                    else
                    {
                        ...
                        rbt->changeWord(nword, rbt->ans->translate);
                ...
                else if(whoChecked == 2)
                {
                    ...
                    else
                    {
                        ...
                        rbt->changeWord(rbt->ans->word, nature + " " + mean);
                        QMessageBox::information(NULL, "提示", "更新成功");
                    }
                }
                else if(whoChecked == 3)
                {
                    ...
                    else
                    {
                        ...
                        rbt->changeWord(rbt->ans->word, rbt->ans->translate + "@" + nature + " " + mean);
                        QMessageBox::information(NULL, "提示", "更新成功");
                    }
                }
            }
