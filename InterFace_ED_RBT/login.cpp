    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else if(whoCalling == 4) QDesktopServices::openUrl(QUrl::fromLocalFile("file:///C:\\CurriculumDesign\\ElectronicDictionary-rbt\\Dictionary"));
                else if(whoCalling == 5) QDesktopServices::openUrl(QUrl::fromLocalFile("file:///C:\\CurriculumDesign\\ElectronicDictionary-rbt\\ElectronicDictionary-rbt"));
            }
        }
    }
}
